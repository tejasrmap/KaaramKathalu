            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  {wishlistCount > 0 && (
                    <span className="absolute -top-1 -right-2 bg-warm-accent text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center border border-white shadow-xs">
                      {wishlistCount}
                    </span>
                  )}
                </div>
                <span className="text-[10px] font-heading tracking-wider uppercase">Saved</span>
              </Link>
              ...
              <button
                type="button"
                onClick={() => setIsCartOpen(true)}
                className="flex flex-col items-center justify-center py-1 px-3 rounded-xl transition-all cursor-pointer text-warm-dark/60 hover:text-warm-dark relative active:scale-95"
              >
                <div className="relative">
                ...
                <span className="text-[10px] font-heading tracking-wider uppercase">Bag</span>
              </button>
