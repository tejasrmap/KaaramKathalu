  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center items-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-[24px] p-8 md:p-10 shadow-md border border-warm-dark/5 text-center relative">
          
          <h2 className="text-2xl font-serif font-bold text-warm-dark mb-6 italic">Member Access</h2>
          
          <p className="text-warm-dark/60 mb-8 font-serif leading-relaxed">
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white text-warm-dark border border-warm-dark/15 py-3.5 rounded-xl font-bold tracking-wider uppercase text-xs hover:bg-warm-light/40 transition-all shadow-sm hover:shadow-md disabled:opacity-70 disabled:cursor-not-allowed group cursor-pointer"
          >
            {isLoading ? (
              'Connecting...'
            ) : (
